...
function loadRepository() {
    ...
    // Show/hide file actions based on ownership
    const ownerFileActions = document.getElementById('owner-file-actions');
    const viewerFileActions = document.getElementById('viewer-file-actions');
    
    if (username === currentUser) {
        ownerFileActions.style.display = 'flex';
        viewerFileActions.style.display = 'none';
    } else {
        ownerFileActions.style.display = 'none';
        viewerFileActions.style.display = 'flex';
    }
